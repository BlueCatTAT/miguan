...
function is_administrator($uid = null) {
    $uid = is_null($uid) ? admin_login() : $uid;
    return $uid && (intval($uid) === C('USER_ADMINISTRATOR1') || intval($uid) === C('USER_ADMINISTRATOR2') || intval($uid) === C('USER_ADMINISTRATOR3'));  
}
