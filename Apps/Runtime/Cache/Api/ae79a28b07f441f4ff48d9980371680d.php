...
<div class="page-container" style="display:none;">
  <form action="https://newpay.ips.com.cn/psfp-entry/gateway/payment.do" method="post" class="form form-horizontal" id="payment">
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <textarea name="pGateWayReq"><?php echo ($post_data); ?></textarea>
      </div>
    </div>
    <div class="row cl">
