...
<div class="page-container">
  <table class="table table-hover table-responsive" id="datalist">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
      ...
      <td>
        <a href="<?php echo U('/admin/product/product_edit', array('id' => $item['id']));?>" class="btn btn-warning btn-xs">编辑</a>
        <a href="<?php echo U('/admin/product/product_del', array('id' => $item['id']));?>" class="btn btn-danger btn-xs">删除</a>
      </td>
