...
<div class="page-container">
  <form action="https://ebp.ips.com.cn/fpms-access/action/withdrawal/withdrawal.html" method="post" class="form form-horizontal">
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <textarea name="ipsRequest"><?php echo ($ipsRequest); ?></textarea>
      </div>
    </div>
    <div class="row cl">
