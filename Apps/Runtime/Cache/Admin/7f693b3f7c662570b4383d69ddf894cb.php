...
<div class="page-container">
  <form action="#" method="post" class="form form-horizontal">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text" value="<?php echo ($info['trade']); ?>" placeholder="" name="trade">
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-3">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text" value="<?php echo ($info['return_url']); ?>" placeholder="" name="return_url">
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-3">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text" value="<?php echo ($info['notify_url']); ?>" placeholder="" name="notify_url">
      </div>
    </div>
    <div class="row cl">
