...
<div class="page-container">
  <div class="cl pd-5 bg-1 bk-gray">
    <span class="l">
      <a class="btn btn-primary radius" data-title="添加代理" data-href="<?php echo U('/admin/agent/agent_add');?>" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont"></i> 添加代理</a>
    </span> 
  </div>
  <div class="mt-20">
    <table class="table table-hover table-responsive" id="datalist">
      ...
      <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
        ...
        <td>
          <?php if($item['type'] == 2): ?>一级代理<?php endif; ?>
          <?php if($item['type'] == 3): ?>二级代理<?php endif; ?>
        </td>
        <td><?php echo ($item['username']); ?></td>
        <td><?php echo ($item['mobile']); ?></td>
        <td><?php echo (date("Y-m-d H:i:s",$item['addtime'])); ?></td>
        <td>
          <a data-title="查看代理用户" data-href="<?php echo U('/admin/agent/customer_list', array('id' => $item['id']));?>" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont f-18">&#xe644;</i></a>
          <a data-title="查看代理信息" data-href="<?php echo U('/admin/agent/agent_info', array('id' => $item['id']));?>" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont f-18">&#xe705;</i></a>
          <a data-title="编辑代理信息" data-href="<?php echo U('/admin/agent/agent_edit', array('id' => $item['id']));?>" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont f-18">&#xe60c;</i></a>
          <a href="<?php echo U('/admin/agent/agent_del', array('id' => $item['id']));?>" ><i class="Hui-iconfont f-18">&#xe609;</i></a>
        </td>
