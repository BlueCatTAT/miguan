...
<div class="page-container">
  <form action="" method="post" class="form form-horizontal">
    ...
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>网站名：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text" name="site_name" value="<?php echo ($site_info["site_name"]); ?>">
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>域名(去掉http://)：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text" name="site_domain" value="<?php echo ($site_info["site_domain"]); ?>">
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>网站ip(去掉http://)：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text" name="site_ip" value="<?php echo ($site_info["site_ip"]); ?>">
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>APPID：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text" name="appid" value="<?php echo ($site_info["appid"]); ?>">
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>APPSECRET：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text" name="appsecret" value="<?php echo ($site_info["appsecret"]); ?>">
      </div>
    </div>
    <div class="row cl">
