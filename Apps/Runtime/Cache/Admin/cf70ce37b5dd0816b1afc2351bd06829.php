...
<div class="page-container">
  ...
  <div class="mt-20">
    <table class="table table-border table-bordered table-bg">
      <tr>
        <td>总单数：<?php echo ($total_count_1); ?> + <?php echo ($total_count_2); ?> * 0.5 = <?php echo ($total_count_1 + $total_count_2); ?></td> 
        <td>总收益：<?php echo (sprintf('%.2f', $total_count_1 + $total_count_2)); ?></td> 
      </tr>
    </table>
  </div>
  <div class="mt-20">
    <table class="table table-hover table-responsive" id="datalist">
      ...
      <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
        ...
        <td>
          ...
          <?php if($item['sale'] == 1): ?>寄售中<?php endif; ?>
          <?php if($item['sale'] == 2): ?>已处理<?php endif; ?>
        </td>
