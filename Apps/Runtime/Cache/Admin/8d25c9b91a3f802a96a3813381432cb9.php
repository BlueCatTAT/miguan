...
<div class="page-container">
  <div class="cl pd-5 bg-1 bk-gray">
    <span class="l">
      <a class="btn btn-primary radius" data-title="添加广告" data-href="<?php echo U('/admin/ad/ad_add');?>" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont"></i> 添加广告</a>
    </span> 
  </div>
  <table class="table table-hover table-responsive" id="datalist">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
      ...
      <td>
        <a href="<?php echo U('/admin/ad/ad_edit', array('id' => $item['id']));?>" class="btn btn-warning btn-xs">编辑</a>
        <a href="<?php echo U('/admin/ad/ad_del', array('id' => $item['id']));?>" class="btn btn-danger btn-xs">删除</a>
      </td>
