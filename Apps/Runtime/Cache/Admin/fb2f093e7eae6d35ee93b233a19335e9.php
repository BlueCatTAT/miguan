    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <select name="type" class="select">
          <?php if(is_array($list)): foreach($list as $key=>$item): ?><option value="<?php echo ($item['type']); ?>" <?php if($item['type'] == $info['type']): ?>selected<?php endif; ?> ><?php echo ($item['name']); ?></option><?php endforeach; endif; ?>
        </select>
      </div>
    </div>
    <div class="row cl">
