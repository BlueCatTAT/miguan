  ...
  <table class="table table-hover table-responsive" id="datalist">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
      ...
      <td>
        ...
        <?php if($item['sale'] == 100): ?>寄售处理<?php endif; ?>
        <?php if($item['sale'] == 200): ?>邮寄处理<?php endif; ?>
      </td>
      <td>
        <?php if($item['sale'] == 2): ?><a href="<?php echo U('/admin/order/post_deal', array('id' => $item['id']));?>" class="btn btn-success btn-xs">处理</a><?php endif; ?>
      </td>
