  ...
  <form action="#" method="post" class="form form-horizontal">
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <?php echo ($withdraw_info['customerCode']); ?>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-3">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text" value="<?php echo ($withdraw_info['transferAmount']); ?>" placeholder="" name="transferAmount">
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-3">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <?php echo ($withdraw_info['bankCard']); ?>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-3">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <?php if(is_array($bank_list)): foreach($bank_list as $key=>$bank): if($bank['code'] == $withdraw_info['bankCode']): echo ($bank['name']); endif; endforeach; endif; ?>
      </div>
    </div>
    <div class="row cl">
