...
<div class="page-container">
  <table class="table table-hover table-responsive" id="datalist">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
      ...
      <td>
        <a data-title="查看订单" data-href="<?php echo U('/admin/order/order_list', array('uid' => $item['id']));?>" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont f-18">&#xe644;</i></a>
      </td>
